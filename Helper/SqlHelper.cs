...
namespace Kpakam.Helper
{
    public sealed class SqlHelper
    {
        ...
        public static string ToQuery( string SpName, params object[] parameterValues)
        {
            ...
            {
                Res += " " + parameterValues[i].ToString() + " ,";
            }
        ...
        #region Included Routine For Long Data Processing or Extraction

        public static DataSet ProcessDataset(string ConnectionString, string CommandText, CommandType CommandType, SqlParameter[] paramss = null)
        {
            DataSet ds = new DataSet();
            SqlDataAdapter da = new SqlDataAdapter();
            string CmdStr = CommandText;
            string Conn = ConnectionString; SqlConnection Connection = new SqlConnection(Conn);
            try
            {
                SqlCommand Command = new SqlCommand(CmdStr, Connection); Command.CommandType = CommandType;
                if (paramss != null)
        ...
        public static int ProcessQuery(string ConnectionString, string CommandQuery)
        {
            string CmdStr = CommandQuery;
            string Conn = ConnectionString; SqlConnection Connection = new SqlConnection(Conn);
            try
            {
                SqlCommand Command = new SqlCommand(CmdStr, Connection); Command.CommandType = CommandType.Text;
                Command.CommandTimeout = 0; Connection.Open();
        ...
        public static int ProcessQuery(string ConnectionString, string CommandText, CommandType CommandType, SqlParameter[] @params)
        {
            string CmdStr = CommandText;
            string Conn = ConnectionString; SqlConnection Connection = new SqlConnection(Conn);
            try
